...
def create_app():
    ...
    for _ in range(20):
        ...
        sp = random.choice(["Coccus", "Rod", "Spirillum"])
        env.organisms.append(Bacterium(x, y, SPECIES_PROFILES[sp]))
    for _ in range(3):
        x, y = random.uniform(0, env.width), random.uniform(0, env.height)
...
updater = SimulationUpdater(env, io, 0.2)
